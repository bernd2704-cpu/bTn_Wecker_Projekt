...
// Basis: bTn_Alarm_4v6 – FreeRTOS + State Machine + WiFi-Konfigurator
...
const char PGMInfo[] = "bTn_Alarm_4v6.ino";                                             // PROGMEM-fähig; kein String-Heap-Fragment
...
static void runCuckooMachine() {
  static uint8_t lastCuckooMin = 0xFF;                                                   // Minuten-Sperre: verhindert Doppelstart bei 500 ms-Task-Takt
  switch (cuckooState) {

    case CUCKOO_IDLE:
      if (t_min == 0 && t_sec == 0 && cuckoo_on && t_hour != lastCuckooMin) {           // t_hour als stündliche Sperre
        lastCuckooMin = t_hour;
