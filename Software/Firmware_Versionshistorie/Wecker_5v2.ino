...
// Basis: bTn_Alarm_5v2 – FreeRTOS + State Machine + WiFi-Konfigurator
...
const char PGMInfo[] = "bTn_Alarm_5v2.ino";                                             // PROGMEM-fähig; kein String-Heap-Fragment
...
void setup() {
  ...
  snprintf(str_reset, sizeof(str_reset), "%4lu", (unsigned long)resetCount);            // rechtsbündig 4-stellig
