...
// Basis: bTn_Alarm_9v0 – FreeRTOS + State Machine + WiFi-Konfigurator
...
const char PGMInfo[] = "bTn_Alarm_9v0";                                                  // PROGMEM-fähig; kein String-Heap-Fragment
...
// ── Konfiguration ────────────────────────────────────────────
#include "SysConf_9v0.h"           // Pin-Belegung, Timing-Konstanten, Touch-Schwellwerte
#include "WEB.h"
...
void setup() {
  ...
  const esp_task_wdt_config_t twdt_cfg = {
    .timeout_ms    = WDT_HARDWARE_MS,  // aus SysConf_9v0.h
  ...
  Serial.println("[TWDT] Hardware Task Watchdog aktiv (" + String(WDT_HARDWARE_MS) + " ms)");
}
